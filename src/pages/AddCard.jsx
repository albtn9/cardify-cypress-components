            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                ...
                <input
                  ...
                  maxLength={19}
                  className={`w-full bg-zinc-800 border rounded-xl px-4 py-3 text-white placeholder-zinc-500 focus:outline-none focus:ring-2 transition-colors ${errors.number
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full bg-zinc-800 border rounded-xl px-4 py-3 text-white placeholder-zinc-500 focus:outline-none focus:ring-2 transition-colors ${errors.holderName
                      ? 'border-red-500 focus:ring-red-500'
                      : 'border-zinc-700 focus:ring-lime-300 focus:border-lime-300'
                    }`}
                />
              ...
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="MM/AA"
                    maxLength={5}
                    className={`w-full bg-zinc-800 border rounded-xl px-4 py-3 text-white placeholder-zinc-500 focus:outline-none focus:ring-2 transition-colors ${errors.expirationDate
                        ? 'border-red-500 focus:ring-red-500'
                        : 'border-zinc-700 focus:ring-lime-300 focus:border-lime-300'
                      }`}
                  />
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      placeholder="123"
                      maxLength={4}
                      className={`w-full bg-zinc-800 border rounded-xl px-4 py-3 pr-12 text-white placeholder-zinc-500 focus:outline-none focus:ring-2 transition-colors ${errors.cvv
                          ? 'border-red-500 focus:ring-red-500'
                          : 'border-zinc-700 focus:ring-lime-300 focus:border-lime-300'
                        }`}
                    />
                  ...
                  {banks.map(bank => {
                    return (
                      <button
                        ...
                        className={`relative flex flex-col items-center justify-center p-4 rounded-2xl border-2 transition-all duration-300 transform hover:scale-105 ${cardData.bank === bank.value
                      ...
                      >
                        <div className={`w-16 h-12 flex items-center justify-center mb-3 transition-all duration-300 ${cardData.bank === bank.value
                            ? 'scale-110'
                        ...
                        <div className={`font-medium text-xs text-center transition-colors duration-300 ${cardData.bank === bank.value
                            ? 'text-lime-300'
                            : 'text-white'
                          }`}>
                          {bank.label}
              ...
              {notification.message && (
                <div className={`notice-success rounded-xl p-4 ${notification.type === 'success'
                    ? 'bg-green-500/10 border border-green-500'
                    : 'bg-red-500/10 border border-red-500'
                  }`}>
                  <div className={`text-sm ${notification.type === 'success' ? 'text-green-400' : 'text-red-400'
                    }`}>
                    {notification.message}
                  </div>
                </div>
